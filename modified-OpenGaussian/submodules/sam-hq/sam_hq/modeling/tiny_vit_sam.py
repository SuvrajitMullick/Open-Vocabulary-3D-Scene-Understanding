...
_provided_checkpoints = {
    'tiny_vit_5m_224_custom': 'tiny_vit_5m_22kto1k_distill',
    'tiny_vit_11m_224_custom': 'tiny_vit_11m_22kto1k_distill',
    'tiny_vit_21m_224_custom': 'tiny_vit_21m_22kto1k_distill',
    'tiny_vit_21m_384_custom': 'tiny_vit_21m_22kto1k_384_distill',
    'tiny_vit_21m_512_custom': 'tiny_vit_21m_22kto1k_512_distill',
}
...
def tiny_vit_5m_224_custom(pretrained=False, num_classes=1000, drop_path_rate=0.0):
    return TinyViT(
...
@register_tiny_vit_model
def tiny_vit_11m_224_custom(pretrained=False, num_classes=1000, drop_path_rate=0.1):
    return TinyViT(
        num_classes=num_classes,
...
@register_tiny_vit_model
def tiny_vit_21m_224_custom(pretrained=False, num_classes=1000, drop_path_rate=0.2):
    return TinyViT(
        num_classes=num_classes,
...
@register_tiny_vit_model
def tiny_vit_21m_384_custom(pretrained=False, num_classes=1000, drop_path_rate=0.1):
    return TinyViT(
        img_size=384,
        num_classes=num_classes,
        embed_dims=[96, 192, 384, 576],
...
@register_tiny_vit_model
def tiny_vit_21m_512_custom(pretrained=False, num_classes=1000, drop_path_rate=0.1):
    return TinyViT(
        img_size=512,
        num_classes=num_classes,
        embed_dims=[96, 192, 384, 576],
