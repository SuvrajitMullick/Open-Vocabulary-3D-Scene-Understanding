...
from sam_hq import SamAutomaticMaskGenerator, sam_model_registry
import cv2
...
def sam_encoder(image):
    ...
    # pre-compute masks
    masks_hq = mask_generator.generate(image)
    # pre-compute postprocess
    masks_hq, = masks_update(masks_hq, iou_thr=0.8, score_thr=0.7, inner_thr=0.5)
    ...
    seg_images, seg_maps = {}, {}
    seg_images['hq'], seg_maps['hq'] = mask2segmap(masks_hq, image)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sam_ckpt_path', type=str, default="ckpts/sam_hq_vit_h.pth")
    ...
    save_folder = os.path.join(dataset_path, prefix + 'language_features_sam_hq')
