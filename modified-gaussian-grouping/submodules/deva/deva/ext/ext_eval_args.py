...
def add_ext_eval_args(parser: ArgumentParser):
    ...
    #                     default='checkpoints/GroundingDINO_SwinT_OGC.py')
    ...
    # SAM
    parser.add_argument('--SAM_CHECKPOINT_PATH', default='checkpoints/sam_vit_h_4b8939.pth')
    
    # HQ-SAM
    parser.add_argument('--HQ_SAM_CHECKPOINT_PATH', default='checkpoints/sam_hq_vit_h.pth')
    
    # # Light HQ-SAM
    # parser.add_argument('--LIGHT_HQ_SAM_CHECKPOINT_PATH', default='checkpoints/sam_hq_vit_tiny.pth')

    # # Mobile SAM
    # parser.add_argument('--MOBILE_SAM_CHECKPOINT_PATH', default='checkpoints/mobile_sam.pt')
...
#     parser.add_argument('--sam_variant', default='sam', help='sam/sam_hq')
#     return parser
...
def add_auto_default_args(parser):
    ...
    parser.add_argument('--sam_variant', default='sam', help='sam/sam_hq/sam_unified')
