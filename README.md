...
- **HQ-SAM on cropped renders** is optimal for the Sparse Voxels based representations (Work 3), outperforming CAHMU-unified by +5.40% — the voxel depth-ordering amplifies HQ-SAM boundary precision.
