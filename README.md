...
[![Thesis Report](https://img.shields.io/badge/Thesis-Report-blue?logo=googledrive&logoColor=white)](https://drive.google.com/file/d/1sG29FLyqrTk-zCRv5_TtqwHDwH2ynzs9/view?usp=sharing)
[![Thesis Poster](https://img.shields.io/badge/Thesis-Poster-orange?logo=googledrive&logoColor=white)](https://drive.google.com/file/d/19JahL3yrDpGQ8RpCrGGrhf9YYxd-MriU/view?usp=sharing)
...
<p align="center"><em>Figure 2 — Feature optimisation architecture shared by Works 2 and 3. Preprocessing supplies cropped black-background rendered and original mask supervision. Modification 1 adds Multi-view Semantic Tracing with Probabilistic KL Distillation (ℒ<sub>KL–ST</sub>), retained in the best configuration for Work 3. Modification 2 adds 2D & 3D Contrastive Learning. Modification 3 adds 2D & 3D Hypersphere Regularisation, retained in the best configuration for Work 2. For Work 3, the Gaussian-Grouping backbone is replaced by SVRaster and GST is correspondingly replaced by VST; all other components are unchanged. Steps shown in green are adopted into the final configuration of the respective Works; steps shown in blue were evaluated and found to retain a similar best configuration like Modification 1 for Work 3.</em></p>
