...
#include "src/apply_weights.h"
#include "src/backward.h"
#include "src/sh_compute.h"
#include "src/sh_obj_compute.h"
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("rasterize_voxels_apply_weights", &APPLY_WEIGHTS::rasterize_voxels_apply_weights);
    ...
    m.def("sh_obj_compute", &SH_OBJ_COMPUTE::sh_obj_compute);
    m.def("sh_obj_compute_bw", &SH_OBJ_COMPUTE::sh_obj_compute_bw);
