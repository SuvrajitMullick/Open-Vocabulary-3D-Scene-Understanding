...
def read_colmap_dataset(source_path, image_dir_name, mask_dir_name, object_dir_name, use_test, test_every, camera_creator):
    ...
    for key in keys:
        ...
        # Load object if there is
        object_path = (source_path / object_dir_name / frame.name).with_suffix('.png')
    ...
    if use_test:
        ...
        train_cam_lst = [c for c in cam_lst if c.image_name not in test_cam_names]
        test_cam_lst = [c for c in cam_lst if c.image_name in test_cam_names]
    else:
        train_cam_lst = cam_lst
        test_cam_lst = []
        
    print("Training images:     ", len(train_cam_lst))
    print("Testing images:     ", len(test_cam_lst))
