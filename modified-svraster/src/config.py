...
cfg.model = CfgNode(dict(
    ...
    num_objects = 16,         # Number of bits to represent a object
...
cfg.regularizer = CfgNode(dict(
    ...
    hypersphere_lambda_3d = 0.00005,
    hypersphere_lambda_2d = 0.00005,
    contrastive_lambda_2d = 0.00002,
    contrastive_lambda_3d = 0.001,
    ...
    # Object loss
    lambda_object_2D = 0.05,
    lambda_object_3D = 0.2,
    lambda_object_3D_wt = 10,
